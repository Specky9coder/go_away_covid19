...
//           style: getPageTitleTestStyle(14.0),
//         ),
//       ),
//       body: Container(
//         color: getPageBackgroundColor(),
//         child: ListView(
//           children: [getUserCountryStates(userCountryData)],
//         ),
//       ),
//     );
//   }
// }
//
// Widget getUserCountryStates(context) {
//   return Container(
//     width: MediaQuery
//         .of(context)
//         .size
...
class _CountryDetailsState extends State<CountryDetails> {
  ...
  void initState() {
    ...
    dataMap.putIfAbsent(
      "Confirmed",
      () => userCountryData.cases.toDouble(),
    );
    dataMap.putIfAbsent(
      "Recovered",
      () => userCountryData.recovered.toDouble(),
    );
    dataMap.putIfAbsent(
      "Deaths",
      () => userCountryData.deaths.toDouble(),
    );
  }
